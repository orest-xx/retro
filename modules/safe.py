...
from config import SAFE_ABI, SAFE_CONTRACT, ZERO_ADDRESS, SAFE_COMPATIBILITY_CONTRACT, SAFEV2_CONTRACT
    ...
    async def create_safe(self):
        ...
        setup_data = self.contract.encodeABI(
            ...
            args=[
                ...
                ZERO_ADDRESS,
                "0x",
                self.w3.to_checksum_address(SAFE_COMPATIBILITY_CONTRACT),
                ZERO_ADDRESS,
                0,
                ZERO_ADDRESS
            ]
        ...
        transaction = await self.contract.functions.createProxyWithNonce(
            self.w3.to_checksum_address(SAFEV2_CONTRACT),
            setup_data,
            int(time.time()*1000)
