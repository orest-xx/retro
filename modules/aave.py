...
from config import AAVE_CONTRACT, AAVE_WETH_CONTRACT, AAVE_ETH_CONTRACT, AAVE_ABI
...
class Aave(Account):
    ...
    async def deposit(
        ...
        transaction = await self.contract.functions.depositETH(
            self.w3.to_checksum_address(AAVE_ETH_CONTRACT),
            self.address,
            0
    ...
    async def withdraw(self) -> None:
        ...
        if amount > 0:
            ...
            await self.approve(amount, AAVE_WETH_CONTRACT, AAVE_CONTRACT)
